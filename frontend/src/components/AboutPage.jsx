              ...
              <div className="relative mb-8">
                ...
                >
                  <div className="w-full h-full rounded-full overflow-hidden border-4 border-[var(--bg-primary)] shadow-2xl relative bg-[var(--bg-secondary)] flex items-center justify-center">
                    <div className={`w-3/4 h-3/4 rounded-full bg-gradient-to-br ${member.color} blur-xl opacity-40 animate-pulse`} />
                    <div className={`w-1/2 h-1/2 rounded-full bg-gradient-to-br ${member.color} relative z-10 shadow-inner`} />
